            ...
            <tbody>
              {reportData.items.map((item, index) => (
                <tr key={index}>
                  ...
                  <td>{item.paytype}</td>
                  <td>{item.numberofsale}</td>
                  <td style={{ textAlign: "right" }}>{(item.finaltotaliqd || 0).toLocaleString()}</td>
                  <td style={{ textAlign: "right" }}>{(item.finaltotalusd || 0).toLocaleString(undefined, { minimumFractionDigits: 2 })}</td>
