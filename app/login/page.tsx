  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success && result.user) {
        ...
        toast.success(`${t('welcome', currentLanguage.code)} ${result.user.full_name}!`)
        router.push('/home')
      } else {
    ...
    const handleMessage = async (event: MessageEvent) => {
      ...
      if (event.data.type === 'oauth-success' && event.data.provider === provider) {
        if (event.data.user) {
          ...
          toast.success(`${t('welcome', currentLanguage.code)} ${event.data.user.full_name}!`)
          router.push('/home')
        }
